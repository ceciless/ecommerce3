...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'velos');
            }

            return array (  '_controller' => 'Ecommerce\\EcommerceBundle\\Controller\\VelosController::velosAction',  '_route' => 'velos',);
        }

        // presentation
        if (0 === strpos($pathinfo, '/velo') && preg_match('#^/velo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'presentation')), array (  '_controller' => 'Ecommerce\\EcommerceBundle\\Controller\\VelosController::presentationAction',));
        }

        // categorieVelos
        if (0 === strpos($pathinfo, '/categorie') && preg_match('#^/categorie/(?P<categorie>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'categorieVelos')), array (  '_controller' => 'Ecommerce\\EcommerceBundle\\Controller\\VelosController::categorieAction',));
        }
