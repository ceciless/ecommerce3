...
class Utilisateurs extends \Utilisateurs\UtilisateursBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'reserver', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'velos', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'profiles', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addReserver(\Ecommerce\EcommerceBundle\Entity\Reserver $reserver)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReserver', array($reserver));

        return parent::addReserver($reserver);
    }
    ...
    public function removeReserver(\Ecommerce\EcommerceBundle\Entity\Reserver $reserver)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReserver', array($reserver));

        return parent::removeReserver($reserver);
    }
    ...
    public function getReserver()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReserver', array());

        return parent::getReserver();
    }
    ...
    public function addProfile(\Ecommerce\EcommerceBundle\Entity\UtilisateursProfiles $profiles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addProfile', array($profiles));

        return parent::addProfile($profiles);
    }
    ...
    public function removeProfile(\Ecommerce\EcommerceBundle\Entity\UtilisateursProfiles $profiles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeProfile', array($profiles));

        return parent::removeProfile($profiles);
    }
    ...
    public function addVelo(\Ecommerce\EcommerceBundle\Entity\Velos $velos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addVelo', array($velos));

        return parent::addVelo($velos);
    }
    ...
    public function removeVelo(\Ecommerce\EcommerceBundle\Entity\Velos $velos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeVelo', array($velos));

        return parent::removeVelo($velos);
    }
    ...
    public function getVelos()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVelos', array());

        return parent::getVelos();
    }
