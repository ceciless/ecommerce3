 ...
 */
class Velos extends \Ecommerce\EcommerceBundle\Entity\Velos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'image', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'tva', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'categorie', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'velonom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'description', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'position', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'prix', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Velos' . "\0" . 'disponible');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Velos $proxy) {
    ...
    public function setVelonom($velonom)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVelonom', array($velonom));

        return parent::setVelonom($velonom);
    }
    ...
    public function getVelonom()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVelonom', array());

        return parent::getVelonom();
    }
