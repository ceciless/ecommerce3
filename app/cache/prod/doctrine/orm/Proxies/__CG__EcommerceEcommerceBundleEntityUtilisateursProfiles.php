 ...
 */
class UtilisateursProfiles extends \Ecommerce\EcommerceBundle\Entity\UtilisateursProfiles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'utilisateur', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'nom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'prenom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'telephone', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'adresse', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'pays', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'ville', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'complement', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\UtilisateursProfiles' . "\0" . 'cp');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UtilisateursProfiles $proxy) {
