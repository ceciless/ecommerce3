 ...
 */
class Reserver extends \Ecommerce\EcommerceBundle\Entity\Reserver implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Reserver' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Reserver' . "\0" . 'utilisateur', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Reserver' . "\0" . 'valider', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Reserver' . "\0" . 'date', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Reserver' . "\0" . 'reference', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Reserver' . "\0" . 'velos');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reserver $proxy) {
    ...
    public function setVelos($velos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVelos', array($velos));

        return parent::setVelos($velos);
    }
